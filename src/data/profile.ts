...
私の強みは、特定の領域に縛られない技術への探求心と、チームを牽引する推進力です。これまでWebアプリ開発から仮想化基盤運用、ハードウェア制御まで幅広く経験し、システム全体を俯瞰する視点を養いました。

個人としての技術開発にとどまらず、技術と人を掛け合わせて組織の力を最大化することにも注力してきました。ゲーム制作サークルでは部長兼テックリードとしてGitHubを導入し開発フローを刷新したほか、100名規模のサークル連合代表として組織マネジメントを経験しました。
